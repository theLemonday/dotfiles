...
_G.packer_plugins = {
  ...
  ["neovim-session-manager"] = {
    loaded = true,
    path = "/home/thearchitecturer/.local/share/nvim/site/pack/packer/start/neovim-session-manager",
  ...
  ["vim-cmake"] = {
    loaded = true,
    path = "/home/thearchitecturer/.local/share/nvim/site/pack/packer/start/vim-cmake",
